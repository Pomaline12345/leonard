        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">Church Building Project, Lagos</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 28th Aug, 2019</span>
                  <span><i class="fa fa-archive"></i> <a href="donate.php">TACN Abule Egba District Centre</a>, <a href="donate.php">Lagos</a></span>
                </span>
                <div class="spacer-20"></div>
                <div class="row">
                	<div class="col-md-7">
              			<img src="images/nate.jpg" class="img-responsive">
                    </div>
                	<div class="col-md-5">
                        <ul class="list-group">
                ...
                <p>In case you are willing to support the ongoining church building project or the ministry, below is our Account Numbers you can donate through it, God will surely bless you for this. </p> <br><br>
               <p><b>Bank Name : First City Monument Bank (FCMB) </b></p>
               <p><b>Account Name : Tac Abule Egba Acct2 (Church Account) </b></p>
               <p><b>Account Number : 2016877342</b></p>  <br><br>

                <p><b>Bank Name : Access Bank</b></p>
               <p><b>Account Name : The Apostolic Church (Nehemiah Project Account) </b></p>
               <p><b>Account Number : 0703420259</b></p> 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <p class="small short">If you would prefer to call in your donation, please call, +2348063516855 </p>
                  </div>
                </div>
              </div>
            </div>
