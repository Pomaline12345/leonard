...
<title>Tac Abule Egba District</title>
    ...
    <div class="topbar">
      <div class="container">
        <div class="row">
          ...
          <h1 class="logo"> <a href="index.php"><img src="images/moses.png" alt="Logo"></a> </h1>
          </div>
          <div class="col-md-8 col-sm-6 col-xs-4">
            <ul class="top-navigation ">
              <li><a href="donate.php">Donate Now</a></li>
              <li><b>2019 WATCH WORD: DELIVER ME OH MY GOD - PS.71 VS 4<b></li> 
            </ul>
          ...
          <div class="col-md-12">
            <nav class="navigation">
              <ul class="sf-menu">
                ...
                <li><a href="about.php">Our History</a>
				<ul class="dropdown">
                    <li><a href="our-excos.php">Pastor/Elders</a></li>
                  </ul>
                </li>
				                <li><a href="programmes.php">Doctrines</a>
                </li>
