...
<html>
<head>
<title>Tac Abule Egba Admin Panel | Home</title>
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.php">Tacn Abule Egba<span>Admin</span></a></h1>
			</div>
						...
						<li class="menu-list">
							<a href="#"><i class="lnr lnr-cog"></i>
								...
								<ul class="sub-menu-list">
									...
									<li><a href="all-excos.php">All Elders</a></li>
								</ul>
						</li>
						...
						<li class="menu-list">
							<a href="#"><i class="lnr lnr-cog"></i>
								...
								<li><a href="add-welcome.php">Welcome Note</a> </li>
									<li><a href="add-about.php">Our History</a> </li>
								...
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/1.jpg) no-repeat center"> </span> 
										 <div class="user-name">
											<p>Pomaline<span>Administrator</span></p>
										 </div>
